...
def self_seg_compare():
    ...
    print "Num of similar tuples: ", sim_count, " out of ", (len(segments) * (len(segments) + 1)) / 2
    print "Percentage of possible tuples that are similar: ", (sim_count / float((len(segments) * (len(segments) + 1)) / 2 * 100, "%"
